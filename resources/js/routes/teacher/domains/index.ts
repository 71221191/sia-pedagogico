...
/**
* @see \App\Http\Controllers\Admin\DomainController::update
 * @see app/Http/Controllers/Admin/DomainController.php:22
 * @route '/docente/dominios/{domain}'
 */
