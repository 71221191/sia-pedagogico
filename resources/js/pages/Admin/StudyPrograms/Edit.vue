...
const form = useForm({
    ...
    short_name: props.studyProgram.short_name,
});

const submit = () => {
    form.post(route('admin.study_programs.update', props.studyProgram.id), {
        onSuccess: () => {
...
<template>
    <Head :title="`Editar Carrera: ${studyProgram.name}`" />
    ...
    <div class="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8 font-sans">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="mb-10">
                ...
                <h1 class="text-3xl font-bold text-gray-900 tracking-tight">Editar Carrera: <span class="text-blue-600">{{ studyProgram.name }}</span></h1>
                <p class="mt-2 text-gray-600">Modifica los detalles de la carrera seleccionada.</p>
            </div>
                ...
                <form @submit.prevent="submit">
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-100 flex justify-end">
                        <button type="submit"
                            ...
                            {{ form.processing ? 'Actualizando...' : 'Actualizar Carrera' }}
                        </button>
                    </div>
                </form>
            </div>
